...
When we type a URL the server sends back raw HTML. 
The browser turns that into something visual and interactive by parsing the HTML and creating a structured in memory representation of every element. This representation is the DOM.
